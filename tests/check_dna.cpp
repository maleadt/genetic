...
START_TEST(test_mod_erase_start) {
...
START_TEST(test_mod_erase_corner) {
...
START_TEST(test_mod_replace_start) {
    unsigned char dnastring[] = {0x01, 0x02, 0x03, 0x02, 0x01, 0x00,
        0x00,
        0x02, 0x03, 0x04, 0x03, 0x02, 0x00,
        0x03, 0x04, 0x05, 0x04, 0x03, 0x00,
...
START_TEST(test_mod_replace_mid) {
    unsigned char dnastring[] = {0x00,
        0x01, 0x02, 0x03, 0x02, 0x01, 0x00,
        0x00,
        0x02, 0x03, 0x04, 0x03, 0x02, 0x00,
...
START_TEST(test_mod_replace_end) {
    unsigned char dnastring[] = {0x00,
        0x01, 0x02, 0x03, 0x02, 0x01, 0x00,
        0x00,
        0x02, 0x03, 0x04, 0x03, 0x02, 0x00,
...
Suite * dna_suite() {
    ...
    tcase_add_test(tc_mod, test_mod_erase_start);
    tcase_add_test(tc_mod, test_mod_erase_mid);
    tcase_add_test(tc_mod, test_mod_erase_end);
    tcase_add_test(tc_mod, test_mod_erase_corner);
    ...
    tcase_add_test(tc_mod, test_mod_replace_start);
    tcase_add_test(tc_mod, test_mod_replace_mid);
    tcase_add_test(tc_mod, test_mod_replace_end);
