               ...
               :    {
               :      bool
  7230  1.2458 :      operator()(const _Tp& __x, const _Tp& __y) const /* std::less<std::string>::operator()(std::string const&, std::string const&) const total:  23649  4.0749 */
 16419  2.8291 :      { return __x < __y; }
               :    };
               :
               :  /// One of the @link s20_3_3_comparisons comparison functors@endlink.
               :  template<typename _Tp>
  ...
  5053  0.8707 :      operator()(const _Pair& __x) const /* std::_Select1st<std::pair<std::string const, char> >::operator()(std::pair<std::string const, char> const&) const total:   9395  1.6188 */
  4342  0.7482 :      { return __x.first; }
               :    };
               :
               :  template<typename _Pair>
...
/* 
 * Total samples for file : "/usr/include/c++/4.3/bits/stl_function.h"
 * 
 *  33044  5.6937
 */
