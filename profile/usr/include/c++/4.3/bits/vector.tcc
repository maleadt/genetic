               ...
               :    void
               :    vector<_Tp, _Alloc>::
               :    _M_insert_aux(iterator __position, const _Tp& __x) /* std::vector<char, std::allocator<char> >::_M_insert_aux(__gnu_cxx::__normal_iterator<char*, std::vector<char, std::allocator<char> > >, char const&) total:      1 1.7e-04 */
               :#endif
               :    {
               :      if (this->_M_impl._M_finish != this->_M_impl._M_end_of_storage)
               :	{
     ...
     1 1.7e-04 :	    _M_check_len(size_type(1), "vector::_M_insert_aux");
               ...
               :#endif /* _VECTOR_TCC */
/* 
 * Total samples for file : "/usr/include/c++/4.3/bits/vector.tcc"
 * 
 *      1 1.7e-04
 */
