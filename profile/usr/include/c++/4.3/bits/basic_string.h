               ...
               :    inline bool
               :    operator<(const basic_string<_CharT, _Traits, _Alloc>& __lhs,
  6103  1.0516 :	      const basic_string<_CharT, _Traits, _Alloc>& __rhs) /* bool std::operator< <char, std::char_traits<char>, std::allocator<char> >(std::basic_string<char, std::char_traits<char>, std::allocator<char> > const&, std::basic_string<char, std::char_traits<char>, std::allocator<char> > const&) total:  22804  3.9293 */
 16701  2.8777 :    { return __lhs.compare(__rhs) < 0; }
               :
               :  /**
...
/* 
 * Total samples for file : "/usr/include/c++/4.3/bits/basic_string.h"
 * 
 *  22804  3.9293
 */
